...
public class AutoResizeTextView extends TextView {
    ...
    public AutoResizeTextView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        TypefaceHelper.setupTextViewWidget(this, attrs,
                R.styleable.VodafoneTextView,
                R.styleable.VodafoneTextView_customTypeface,
                R.styleable.VodafoneTextView_dynamicText);
    ...
    public void superSetTextSize(int startSize) {
